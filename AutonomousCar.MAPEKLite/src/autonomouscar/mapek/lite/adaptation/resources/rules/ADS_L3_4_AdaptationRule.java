...
public class ADS_L3_4_AdaptationRule extends AdaptationRule {
	public static String id = "ADS_L3_4_AdaptationRule";
	...
	public boolean checkAffectedByChange(IKnowledgeProperty arg0) {
		return kp_DrivingLevel.getValue().equals(EDrivingLevel.L3_TrafficJamChauffer) 
				...
				&& kp_RoadStatus.getValue().equals(ERoadStatus.FLUID);
	}
	...
	public IRuleSystemConfiguration onExecute(IKnowledgeProperty property) {
		...
		SystemConfigurationHelper.bindingToAdd(ruleComponentsSystemConfiguration, "driving.L3.HighwayChauffer", "1.0.0",
		...
		bindDistanceSensors(ruleComponentsSystemConfiguration, "driving.L3.HighwayChauffer");
		
		bindLineSensors(ruleComponentsSystemConfiguration, "driving.L3.HighwayChauffer");
