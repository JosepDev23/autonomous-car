...
public class Interact_1_2_AdaptationRule extends AdaptationRule {
	public static String id = "Interact_1_2_AdaptationRule";

	IKnowledgeProperty kp_DrivingLevel = null;
	IKnowledgeProperty kp_DriverFace = null;
	IKnowledgeProperty kp_DriverSeated = null;
	
	public Interact_1_2_AdaptationRule(BundleContext context) {
		super(context, id);
	...
	public boolean checkAffectedByChange(IKnowledgeProperty property) {
		return kp_DrivingLevel.getValue().toString().contains("L3")
			&& kp_DriverFace.getValue().equals(EFaceStatus.SLEEPING)
	...
	public IRuleSystemConfiguration onExecute(IKnowledgeProperty property) {
		...
		SystemConfigurationHelper.componentToAdd(ruleComponentsSystemConfiguration, "interaction.Seat.Driver", "1.0.0");
		SystemConfigurationHelper.bindingToAdd(
				ruleComponentsSystemConfiguration, 
				"interaction.NotificationService", "1.0.0",
				NotificationServiceARC.REQUIRED_SERVICE, 
				"interaction.Seat.Driver", "1.0.0",
				HapticVibrationARC.PROVIDED_MECHANISM);
