...
public class ADS_L3_2_AdaptationRule extends AdaptationRule {
	public static String id = "ADS_L3_2_AdaptationRule";
	...
	public ADS_L3_2_AdaptationRule(BundleContext context) {
		...
		this.setListenToKnowledgePropertyChanges("RoadStatus");
	...
	public boolean checkAffectedByChange(IKnowledgeProperty arg0) {
		return kp_DrivingLevel.getValue().equals(EDrivingLevel.L3_HighwayChauffer) 
				&& kp_RoadType.getValue().equals(ERoadType.HIGHWAY)
	...
	public IRuleSystemConfiguration onExecute(IKnowledgeProperty property) {
		...
		SystemConfigurationHelper.componentToAdd(ruleComponentsSystemConfiguration, "driving.L3.TrafficJamChauffer", "1.0.0");
		...
		SystemConfigurationHelper.bindingToAdd(ruleComponentsSystemConfiguration, "driving.L3.TrafficJamChauffer", "1.0.0",
		...
		bindDistanceSensors(ruleComponentsSystemConfiguration, "driving.L3.TrafficJamChauffer");
		
		bindLineSensors(ruleComponentsSystemConfiguration, "driving.L3.TrafficJamChauffer");
