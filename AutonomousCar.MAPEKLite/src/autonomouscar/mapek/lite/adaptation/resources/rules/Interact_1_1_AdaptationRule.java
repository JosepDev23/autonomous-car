...
public class Interact_1_1_AdaptationRule extends AdaptationRule {
	public static String id = "Interact_1_1_AdaptationRule";

	IKnowledgeProperty kp_DrivingLevel = null;
	IKnowledgeProperty kp_DriverFace = null;
	IKnowledgeProperty kp_DriverHands = null;
	IKnowledgeProperty kp_DriverSeated = null;
	
	public Interact_1_1_AdaptationRule(BundleContext context) {
		super(context, id);

		this.setListenToKnowledgePropertyChanges("DriverFace");
		this.setListenToKnowledgePropertyChanges("DriverHands");
		...
		kp_DriverHands = BasicMAPEKLiteLoopHelper.getKnowledgeProperty("DriverHands");
		kp_DriverSeated = BasicMAPEKLiteLoopHelper.getKnowledgeProperty("DriverSeated");
	}
	
	@Override
	public boolean checkAffectedByChange(IKnowledgeProperty property) {
		return kp_DrivingLevel.getValue().toString().contains("L3")
			&& kp_DriverFace.getValue().equals(EFaceStatus.LOOKING_FORWARD)
			&& kp_DriverHands.getValue().equals(true)
			&& kp_DriverSeated.getValue().equals(true);
	}
